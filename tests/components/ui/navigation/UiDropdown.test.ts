...
describe('UiDropdown', () => {
  it('should render with default props', () => {
    ...
    expect(wrapper.find('.relative.inline-block.text-left').exists()).toBe(
      true
    )
    ...
    const placements = [
      {
        ...
        expectedClass: 'left-0 mt-2 origin-top-left'
      },
      {
        placement: 'bottom-right',
        expectedClass: 'right-0 mt-2 origin-top-right'
      },
      {
        placement: 'top-left',
        expectedClass: 'left-0 mb-2 bottom-full origin-bottom-left'
      },
      {
        placement: 'top-right',
        expectedClass: 'right-0 mb-2 bottom-full origin-bottom-right'
      }
    ] as const
